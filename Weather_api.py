...
#     c = conn.cursor()
#     c.execute(
#         "INSERT INTO locationBasedData VALUES (:zipcode, :max_temp, :min_temp, :day_info, :night_info, :precipitation_sts, :status, :category)",
#         {
#             'zipcode': zipcode,
#             'max_temp': max_temp,
#             'min_temp': min_temp,
...
#
#     select_btn = tk.Button(btn_frame, text="Show Data by ID", font=("Helvetica", 10, "bold"), background="light green",
#                            command=lambda: view_selectd_data(zip_entry.get()))
#     select_btn.grid(row=0, column=1, padx=7, pady=5, ipadx=10)
#
#     delete_btn = tk.Button(btn_frame, text="Delete Data by ID", font=("Helvetica", 10, "bold"),
#                            background="light green", command=lambda: delete_data(zip_entry.get()))
...
#         "http://dataservice.accuweather.com/forecasts/v1/daily/1day/" + code + "?apikey=CFfODWB5pWrrIs0uMBjhGeP5uunW09D9&language=en-us&details=false&metric=false")
...
#             return "In Day: " + info_DailyForecasts[0]['Day']['PrecipitationIntensity'] + " " + \
#                 info_DailyForecasts[0]['Day']['PrecipitationType'] + "\n"
#
#         if info_DailyForecasts[0]['Night']['HasPrecipitation']:
#             return "In night : " + info_DailyForecasts[0]['Night']['PrecipitationIntensity'] + " " + \
#                 info_DailyForecasts[0]['Night']['PrecipitationType'] + "\n"
#
...
#     temp_label2 = tk.Label(root_frame, font=("Helvetica", 10, "bold"), background="light green",
#                            text="Minimum : " + str(min_temp) + " F" + "   ||   " + "Maximum : " + str(max_temp) + " F")
#     current_sts1 = tk.Label(root_frame, font=("Helvetica", 14, "bold"), background="light green", text="Today's Info: ")
#     current_sts2 = tk.Label(root_frame, font=("Helvetica", 10, "bold"), background="light green",
#                             text="Day : " + day_info['IconPhrase'] + "\n\n" + "Night : " + night_info['IconPhrase'])
#     prec_sts_label1 = tk.Label(root_frame, font=("Helvetica", 14, "bold"), background="light green",
#                                text="Precipittion Status : ")
#     prec_sts_label2 = tk.Label(root_frame, font=("Helvetica", 10, "bold"), background="light green",
#                                text=prec_sts_checker())
#     sts_label1 = tk.Label(root_frame, font=("Helvetica", 14, "bold"), background="light green", text="Status :")
#     sts_label2 = tk.Label(root_frame, font=("Helvetica", 10, "bold"), background="light green",
#                           text=tw.fill(Text, width=40))
#     sts_type_label = tk.Label(root_frame, font=("Helvetica", 11, "bold"), background="light green",
#                               text="Type: " + category)
#
#     update_btn = tk.Button(root_frame, text="Save Data", font=("Helvetica", 9, "bold"),
#                            command=lambda: add_to_database(location_code_enrty.get(), min_temp, max_temp,
#                                                            day_info['IconPhrase'], night_info['IconPhrase'],
#                                                            prec_sts_checker(), Text, category))
...
#
#     get_location_btn = tk.Button(root_frame, font=("Helvetica", 11, "bold"), text="GO!",
#                                  command=lambda: get_location_update(location_code_enrty.get()))
#     get_location_btn.grid(row=0, column=2)
#     location_label1 = tk.Label(root_frame, font=("Helvetica", 14, "bold"), background="light green",
#                                text="Enter Location : ")
...
import requests
response = requests.get('''https://chatgpt-api.shn.hk/v1/ \
