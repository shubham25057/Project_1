...
def Register():
    ...
    con = mysql.connector.connect(host="localhost",user="root",password="Shubham@123",database="loginandregister")
    cursor = con.cursor()
...
def Login():
    ...
    con = mysql.connector.connect(host="localhost", user="root", password="Shubham@123", database="loginandregister")
    cursor = con.cursor()
    conn = mysql.connector.connect(host="localhost", user="root", password="Shubham@123", database="loginandregister")
    cursor2 = conn.cursor()
